...
function rotateLogFileIfNecessary(logFilePath) {
...
export function setEngineLoggerConfig(config) {
    ...
    for (const [id, session] of [['primary', primarySession], ['systemAI', systemAISession]]) {
